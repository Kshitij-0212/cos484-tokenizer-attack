...
langs = ['af','am','as','ba','bo','bpy','br','ce','ceb','ckb','cv','cy','dv','eo','fy','ga','gom','hr','is','jbo','la','lb','lo','mg','mhr','min','mt','nds','new','nn','oc','or','os','pms','pnb','ps','sa','sah','scn','sd','sh','sw','tg','tk','tl','ug','vo','wa','wuu','xmf','yi']
